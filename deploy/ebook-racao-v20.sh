...
log "Verifying EBOOK_RACAO configuration"
FUND_STATE="$(
...
select concat_ws('|',
  ...
  campaign_meta->>'goalKg',
  campaign_meta->>'topUpAllowed',
  coalesce(target_amount_cents::text, 'NULL')
)
from public.causes
...
EXPECTED="EBOOK_RACAO|ACTIVE|BRL|FOOD|MYPETS|DOG_FOOD_KG|1|1290|100|true|NULL"
...
log "Verifying public API and ebook impact endpoint"
...
echo
echo "============================================================"
echo "MyPets eBook Racao v20 deployed and verified."
echo "1kg entitlement accounting: OK"
echo "Free top-up accounting: OK"
echo "Server-side CPF validation: OK"
