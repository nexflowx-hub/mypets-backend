...
comment on column public.causes.beneficiary_kind is 'PROTECTOR or first-party MYPETS beneficiary.';
comment on column public.causes.fund_code is 'Stable first-party MyPets fund identifier; null for protector-owned causes.';
comment on column public.causes.is_evergreen is 'Evergreen financial funds do not require a finite fundraising target.';
